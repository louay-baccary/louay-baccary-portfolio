...
const PROJECTS_DESCRIPTION = `Production projects built by ${AUTHOR_NAME}: SaaS platforms, blockchain systems, and AI-assisted engineering.`;
      ...
      <section className="projects-page">
        <header className="projects-header">
          ...
          <p className="page-subtitle">
            Production platforms and systems I&apos;ve built and shipped
          </p>
        </header>
