 ...
 * across pages (e.g. the homepage Person node is referenced from other
 * pages rather than repeated). Pages compose these builders into a single
...
export function websiteNode(): SchemaNode {
  return {
    ...
    url: HOME_URL,
    name: AUTHOR_NAME,
    alternateName: ['louay-baccary-portfolionextjs.vercel.app', 'louaybaccary'],
    description: SITE_DESCRIPTION,
...
/** A WebPage subtype for pages that primarily list things (e.g. projects, books). */
