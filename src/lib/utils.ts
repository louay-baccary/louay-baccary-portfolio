...
export const SITE_DESCRIPTION =
  'Full Stack Engineer with 6+ years of experience building production SaaS platforms, event-driven blockchain systems, and AI-assisted engineering workflows.';
