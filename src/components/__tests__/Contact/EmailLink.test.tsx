...
describe('EmailLink', () => {
  ...
  it('never blanks or snaps back to the address mid-animation', () => {
    ...
    for (let elapsed = 0; elapsed < 120_000; elapsed += 50) {
      ...
      // Looping legitimately re-types the address character by character, so
      // reaching the full address is only legitimate if the previous frame
      // was itself a prefix of it (however many characters long).
      if (shown === localPart) {
